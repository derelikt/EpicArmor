package com.dereliktt.EpicArmor.armor;

import com.dereliktt.EpicArmor.proxy.ProxyClient;
import com.dereliktt.EpicArmor.resources.*;
...
public class CustomArmor extends ItemArmor{
	...
	public CustomArmor(ArmorMaterial material, int render_idx, int type) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer){
		...
		return String.format("%s:textures/models/armor/%s_layer_%d.png", References.mod_id, name, slot == 3 ? 2 : 1);
	}
}
